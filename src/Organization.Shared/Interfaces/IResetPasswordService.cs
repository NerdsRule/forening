...
public interface IResetPasswordService
{
    ...
    public Task<List<TResetPassword>?> GetResetRequestsAsync(CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>Operation status.</returns>
    public Task<FormResult> DeleteResetRequestAsync(int id, CancellationToken cancellationToken = default);
}